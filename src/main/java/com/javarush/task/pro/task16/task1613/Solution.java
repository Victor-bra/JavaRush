...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        LocalTime localTimeFriday = LocalTime.of(WEEKEND_START_FRIDAY_CUT_OFF_HOUR, dateTime.getMinute(), dateTime.getSecond());
        LocalTime localTimeSunday = LocalTime.of(WEEKEND_END_SUNDAY_CUT_OFF_HOUR, dateTime.getMinute(), dateTime.getSecond());
        if ((dateTime.getDayOfWeek() == DayOfWeek.FRIDAY && dateTime.getHour() >= localTimeFriday.getHour()) ||
                dateTime.getDayOfWeek() == DayOfWeek.SATURDAY ||
                (dateTime.getDayOfWeek() == DayOfWeek.SUNDAY && dateTime.getHour() < localTimeSunday.getHour())) {
            return true;
        }
        return false;
    }
